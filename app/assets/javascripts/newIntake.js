...
function displayDefault(){
	var location = $('#record_case_data_child_location').find(":selected").index();
	if (location > 0) {
		...
		$("#record_case_data_child_age_of_client_chosen").closest('.row').show();
		...
		$("#record_case_data_child_age_of_client_chosen").closest('.row').hide();
